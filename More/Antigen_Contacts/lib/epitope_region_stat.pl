...
#   my $dir = ".";                     
my $dir = "/acrm/data/people/ucbterd/data/dataNew/DataMay2015/NR_Complex_Martin";
chdir $dir; 
...
open(my $STAT, '>', "$dir/epitope-stat-G$gap-CR$contacting_residues.txt") or die "File can not open";
open(my $EPITOPE_REGIONS, '>', "$dir/epitope_sequence-G$gap-CR$contacting_residues.txt")
